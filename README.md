...
| 安装包 | 说明 |
| --- | --- |
| [trafmon_0.3.1_x64_en-US.msi](https://github.com/Schweik7/trafmon/releases/download/v0.3.1/trafmon_0.3.1_x64_en-US.msi) | MSI 安装程序（x64） |
| [trafmon_0.3.1_x64-setup.exe](https://github.com/Schweik7/trafmon/releases/download/v0.3.1/trafmon_0.3.1_x64-setup.exe) | NSIS 安装程序（x64） |
